...
/**
 * Componente funcional para la subida de archivos de credenciales de conductores.
 * @module UploadFileAdministrador
 * @description Permite seleccionar, validar y enviar archivos PDF de credenciales asociados a un conductor.
 * @returns {JSX.Element} La vista de subida de archivo de credencial.
 */
const UploadFileAdministrador = () => {
  ...
  /**
   * Sube el archivo de credencial al servidor.
   * @async
   * @function subirArchivoAdministrador
   * @param {File} file - Archivo a subir.
   * @param {string} idUsuario - ID del usuario.
   * @param {string} idConductor - ID del conductor.
   * @returns {Promise<Object>} Respuesta del servidor.
   */
  const subirArchivoAdministrador = async (file, idUsuario, idConductor) => {
    ...
    // Añadimos el archivo
    formData.append('archivoCredencial', file)
    console.log(file)
    console.log(idConductor)
    console.log(idUsuario)
    try {
      const response = await documentosHttp.post('/documentos/credenciales/subir', formData, {
        headers: {
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      await subirArchivoAdministrador(selectedFile, idUsuario, idConductor);
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className='mb-8'>
          <h2 className="text-center text-3xl font-extrabold text-gray-900">
            Bienvenido a Tecno Quality, su rol es: {userData.rol_usuario}
          </h2>
        </div>
...
export default UploadFileAdministrador