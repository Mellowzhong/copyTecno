...
const ViewDriverPsicotecnica = () => {
  ...
  const handleSubirArchivo = (idUsuario, idConductor) => {
    ...
    navigate("/UploadFilePsicotecnica", {
      state: {
        idUsuario: idUsuario,
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <Navegacion titulo={`Listado de conductores (Credencial) [${userData.rol_usuario}]`} />
      {/* Main Content */}
...
export default ViewDriverPsicotecnica
