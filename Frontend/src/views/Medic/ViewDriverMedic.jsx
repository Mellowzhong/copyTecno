...
/**
 * Componente funcional para visualizar y gestionar la lista de conductores y sus formularios médicos.
 * @module ViewDriverMedic
 * @description Permite buscar, filtrar y gestionar los conductores, así como navegar a la edición de sus formularios médicos.
 * @returns {JSX.Element} La vista principal de gestión de conductores médicos.
 */
const ViewDriverMedic = () => {
...
export default ViewDriverMedic