...
/**
 * Componente funcional para la página principal del área médica.
 * @module Medic
 * @description Muestra la bienvenida al usuario según su rol y permite navegar a la vista de gestión de formularios médicos.
 * @returns {JSX.Element} La vista de bienvenida y acceso a la gestión de formularios médicos.
 */
export default function Medic() {
    ...
    /**
     * Navega a la vista de gestión de formularios médicos de conductores.
     * @function navigateToViewDriverMedic
     */
    const navigateToViewDriverMedic = () => {
    ...
    return (
        <div className="flex flex-col items-center justify-center p-6">
            ...
            <div className='flex justify-center w-full'>
                <button
                    onClick={navigateToViewDriverMedic}
